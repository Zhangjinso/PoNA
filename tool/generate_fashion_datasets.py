...
def make_dataset(dir):
	...
	new_root = '/home/zjs/my/Pose-Transfer/fashion_data'
	if not os.path.exists(new_root):
		os.mkdir(new_root)

	train_root = '/home/zjs/my/Pose-Transfer/fashion_data/train'
	if not os.path.exists(train_root):
		os.mkdir(train_root)

	test_root = '/home/zjs/my/Pose-Transfer/fashion_data/test'
	if not os.path.exists(test_root):
		os.mkdir(test_root)

	train_images = []
	train_f = open('/home/zjs/my/Pose-Transfer/fashion_data/train.lst', 'r')
	...
	test_images = []
	test_f = open('/home/zjs/my/Pose-Transfer/fashion_data/test.lst', 'r')
	for lines in test_f:
		lines = lines.strip()
		if lines.endswith('.jpg'):
