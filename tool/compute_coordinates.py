...
#input_folder = '../../grade2/PInet/suppdata'
#output_path = '/home/zjs/my/Pose-Transfer/fashion_data/sgp-supp.csv'

input_folder = './results/market_PATN_aba_self/test_latest/images_crop/'
output_path = './results/market_PATN_aba_self/test_latest/pckh.csv'
