...
MISSING_VALUE = -1
# fix PATH
img_dir  = '/home/zjs/grade2/PInet/suppdata' #raw image path
annotations_file = '/home/zjs/my/Pose-Transfer/fashion_data/sgp-supp.csv' #pose annotation path
save_path = '/home/zjs/my/Pose-Transfer/fashion_data/testK' #path to store pose maps
